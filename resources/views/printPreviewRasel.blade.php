...
<body>
    <div class="mainContainer" style="margin:0px;">
        <div class="topPortion" style="width:100%;height:280px;margin-left:0px;">
            <div class="" style="width:230px;height:100%;float:left;">
                <img src="{{asset('public/images/prescription/NDC-Logo.png')}}" class="mt-3 ml-2"
                    style="height:263px; width:390px;" alt="Responsive image">
            </div>

            <div class=" text-center" style="width:545px;height:100%;float:right;background-color:#007bff;">
                <div class="card text-white border-0" style="width:300px;height:100%;float:left;background-color:#007bff;">
                    <!-- Doc name bn -->
                    <div class="card-body">
                    ...
                    <div class="card   text-white justify-content-center ml-5" 
                        style="width:200px;height:160px;background-color:#007bff;" id="vtime">
                        <!-- Doc name en -->
                        <div class="card-body">
                            ...
                            <p class="card-text" style="font-size:17px;margin-top: 0px;">
                            <strong>
                                {{$doc->vTimeBn}}
                            </strong>
                ...
                <div class="card  text-white border-0 " style="width:245px;height:100%;float:left;background-color:#007bff;">
                    <!-- Doc name en -->
                    <div class="card-body">
    ...
    <div class="middlepart" style="width:100%;height:980px;">
        ...
        <div class="middleRight h-100 float-right" style="width:546px;border-left:2px solid #0099ff;">
            ...
            <div class="prescriptionPart" style="margin-left:80px;margin-top:40px;">
                <pre style="font-size:20px;letter-spacing: 1px;" class="h5">{{$prescription->prescription}}</pre>
                <div class="h4" style="font-size:20px;height:50px;float:none;letter-spacing: 1px;">
